...
//
//    private static final String API_KEY = "da02e9dcf36243328e64214559b0ad80"; // Replace with your actual API key
//    private static final String OUTPUT_FILE = "GPClinicsData.xlsx";
//
//    public static void main(String[] args) {
//        String locationQuery = "General Practice Clinics";
...
//        // Define bounding box coordinates (left, bottom, right, top)
//        double lat1 = 48.680903; // bottom-left latitude
//        double lon1 = 10.716463; // bottom-left longitude
//        double lat2 = 48.755151; // top-right latitude
//        double lon2 = 10.835314; // top-right longitude
//
//        // Construct URL for Geoapify API
//        String urlString = String.format(
//            "https://api.geoapify.com/v2/places?categories=healthcare.general_practitioner&filter=rect:%f,%f,%f,%f&text=%s&apiKey=%s",
//            lon1, lat1, lon2, lat2, query.replace(" ", "%20"), API_KEY
//        );
//
...
//            System.out.println("Error in response: " + jsonObject.getString("error"));
//            return;
//        }
//
...
//                String address = properties.has("formatted") ? properties.getString("formatted") : "N/A";
//                String phone = properties.has("phone") ? properties.getString("phone") : "N/A";
//                String website = properties.has("website") ? properties.getString("website") : "N/A";
//
